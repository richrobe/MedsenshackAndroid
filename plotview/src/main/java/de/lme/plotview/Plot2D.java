...
public class Plot2D extends Plot1D {
     ...
     *
     * @param xPivot Pivot point for xRange. Displayed values will be: [xPivot -
     *               xRange/2; xPivot + xRange/2]
     * @param yPivot Pivot point for yRange.
     * @param xRange Range of values to display in x-direction.
     * @param yRange Range of values to display in y-direction.
     */
    ...
    protected void drawAxis(Canvas can, PlotSurface surface, boolean drawGrid, boolean drawMap) {
        ...
        drawYAxis(can, surface, yAxis, drawGrid);
    }
